...
Básicamente tenemos 2 llamadas principales que es al sistema es la de getAncestor y la de getppid, la primera nos permite obtener el ancestro n-esimos de un proceso, mientras que el getppid devuelve el PID del apdre directo del proceso actual. El sistema busca hacia arriba en el árbol de procesos hasta encontrar los correspondiente.
